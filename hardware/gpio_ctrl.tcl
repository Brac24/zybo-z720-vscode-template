...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1 } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/builds/$_xil_proj_name_/$_xil_proj_name_.gen/sources_1/bd/design_1/hdl/design_1_wrappper.v" ]
} else {
...
set file "[file normalize "$origin_dir/constraints/zyboz7-master.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constraints/zyboz7-master.xdc"
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/constraints/zyboz7-master.xdc"]" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/constraints/zyboz7-master.xdc"]" -objects $obj
